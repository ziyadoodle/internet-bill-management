  ...
  <section class="flex items-center justify-center h-full">
    <div class="container">
      <div class="flex justify-center items-center">
        <div class="flex flex-col backdrop-blur-[30px] bg-[#67676733] w-1/2 h-1/2  rounded-3xl justify-center items-center p-10 2xl:p-16 border-solid border-2 border-white ">
          <div class="flex flex-col space-y-4 h-full w-full top-10 start-14 font-sans mb-12">
          ...
          <form class="w-full" method="post">
            ...
            <div>
              ...
              <input class="shadow appearance-none border rounded w-full p-4 text-white mb-10 leading-tight focus:outline-none focus:shadow-outline bg-transparent" id="password2" type="password" name="password2" required autocomplete="off">
            </div>
