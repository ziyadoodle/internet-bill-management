                ...
                <div class="w-[70%] 2xl:w-[70%] h-[32rem] bg-neutral-600 rounded-lg p-8">
                    ...
                    <form action="" method="POST">
                        <div class="flex flex-col text-white mt-6">
                            ...
                            <div class="flex flex-row w-full items-center pr-10 py-2">
                                <label for="date" class="w-3/12">Date</label> <!-- buat tanggal otomatis-->
                                <input type="date" name="date" id="date" class="h-8 w-9/12 border-none outline-none mt-1 rounded px-4 bg-neutral-500" 
                            ...
                            <div class="flex flex-row w-full items-center pr-10 py-2">
                                ...
                                <div class="price-input w-9/12 flex justify-between">
                                    ...
                                    <input type="text" name="price" id="price" class="h-8 w-11/12 border-none outline-none mt-1 rounded px-4 bg-neutral-500" 
                                    value="" />
                                </div>
                            </div>
