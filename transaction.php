    ...
    <div class="flex flex-row p-6 w-full h-screen">
        ...
        <div class="topbar flex flex-col basis-10/12 px-16 2xl:px-20">
            ...
            <div class="flex flex-row justify-between mt-5">
                <div class="w-[70%] 2xl:w-[70%] bg-neutral-600 rounded-lg p-8">
                ...
                <div class="flex flex-col w-[30%] bg-neutral-600 rounded-xl ml-10">
                    ...
                    <div class="flex flex-col items-start p-4 text-white">
                        <h1>From : </h1>
                        <input type="date" name="from" id="from" class="h-8 w-full border-none outline-none mb-1 rounded px-4 bg-neutral-500" data-target="#reservationdate" autocomplete="off" />
                        <h1>To : </h1>
                        <input type="date" name="to" id="to" class="h-8 w-full border-none outline-none mt-1 rounded px-4 bg-neutral-500" data-target="#reservationdate2" autocomplete="off" />
                    </div>

                    <div class="flex flex-row justify-end w-full items-center pr-10 py-2 mt-6">
                        <button class="bg-neutral-500 text-white rounded-md px-4 py-2 transition duration-300 ease select-none hover:bg-neutral-700 focus:outline-none focus:shadow-outline" onclick="cetakLaporan()">Print</button>
                    </div>
