        ...
        <div class="backdrop-blur-[30px] bg-[#ffffff33] absolute top-44  left-96 w-1/2 h-1/2  rounded-3xl flex justify-center items-center p-16 border-solid border-2 border-white ">
          ...
          <form class="pt-32 z-10" method="post">
            <div class="mb-4 ">
              ...
              <input class="shadow appearance-none border rounded w-full py-2 px-40 text-white leading-tight focus:outline-none focus:shadow-outline  bg-transparent" id="username" type="text" placeholder="Username" name="username" >
            </div>
            <div class="mb-4">
              <label class="block text-white text-sm font-bold mb-2" for="password">
                Password
              </label>
              <input class="shadow appearance-none border border-white rounded w-full py-2 px-3 text-white  leading-tight focus:outline-none focus:shadow-outline bg-transparent" id="password" type="password" placeholder="password"  name="password">
            </div>
            <div class="mb-4 ">
              <label class="block text-white text-sm font-bold mb-2" for="username">
                Confirm password
              </label>
              <input class="shadow appearance-none border rounded w-full py-2 px-40 text-white mb-10 leading-tight focus:outline-none focus:shadow-outline bg-transparent" id="password2" type="password" placeholder="confirm password"  name="password2">
            </div>s
