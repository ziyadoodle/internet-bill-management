                                ...
                                <?php foreach ($package as $row) : ?>
                                    <tr class="">
                                        ...
                                        <td class="flex justify-center py-3">
                                            ...
                                            <a href="deletePackage.php?id=<?= $row['id']; ?>" type="button" id="delButton" name="delete" class="w-4 mr-2 hover:text-neutral-400 hover:cursor-pointer" title="delete" onclick="return confirm('Are you sure?');">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
